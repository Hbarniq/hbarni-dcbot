...
export default class ClientApplication extends Base {
     ...
     */
    updateRoleConnectionsMetata(metadata: Array<RoleConnectionMetadata>): Promise<Array<RoleConnectionMetadata>>;
    /**
     ...
     */
    updateUserRoleConnection(data: RoleConnection): Promise<RoleConnection>;
}
