/** @module Routes/OAuth */
import type { AuthorizationInformation, ClientCredentialsTokenOptions, ClientCredentialsTokenResponse, Connection, ExchangeCodeOptions, ExchangeCodeResponse, OAuthURLOptions, RefreshTokenOptions, RefreshTokenResponse, RevokeTokenOptions, GetCurrentGuildsOptions, RoleConnectionMetadata, RoleConnection } from "../types/oauth";
...
export default class OAuth {
     ...
     */
    getRoleConnectionsMetatdata(applicationID: string): Promise<Array<RoleConnectionMetadata>>;
    /**
     ...
     */
    updateRoleConnectionsMetata(applicationID: string, metadata: Array<RoleConnectionMetadata>): Promise<Array<RoleConnectionMetadata>>;
    /**
     ...
     */
    updateUserRoleConnection(applicationID: string, data: RoleConnection): Promise<RoleConnection>;
}
