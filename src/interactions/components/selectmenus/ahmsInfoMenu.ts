...
export default {
  ...
  exec: async (client: Client, interaction: GuildComponentSelectMenuInteraction) => {
    switch (interaction.data.values.getStrings()[0]) {
      case "infoEmbed":
          ...
          embeds: [
            {
              ...
              fields: [
                ...
                },
                {
                  name: "updates!",
                  value:
                    "mci-reloaded will show the newest and the current installed modpack versions and should automatically configure anything needed for updated versions",
                },
              ],
            },
          ],
